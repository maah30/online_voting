...
<div class="tbl_contain">
    ...
    <div class = sign_up>
   <a href="add_cands.php"><input type="submit" value="ADD CANDIDATE"></a>
    </div>

        <h3 align="center" style="font-family: 'times new roman'; font-size: 25px"><b><br> SANGGUNIANG KABATAAN CANDIDATES </b></h3>
        <table>
            <thead>
                <tr>
                    <th> Candidate ID </th>
        ...
        <tbody>
          <?php
            while($row = mysqli_fetch_assoc($result)) 
            {
              ...
              echo "<td>";
              echo"<a href='dlt_sk.php?id=" . $row['cand_ID'] . "' class='btn btn-info'><i class='bi bi-trash3' style='color: black';></i></a>";
              echo "</td>";
              echo "</tr>";
            }
           ?>               
        ...
        <p style="position: absolute; right: 160px; top: 140px;"><a href="db.php"><input type="submit" value="BACK"></a></p>
    </div>
